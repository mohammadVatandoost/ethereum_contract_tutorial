...
describe('Campaign', () => {
   it('deploy a contract', () => {
   	assert.ok(factory.options.address); // check contract deployed correctly // ok check not to be null
   ...
   it('allowss people to contribute money and marks them as approvers', async () =>{
